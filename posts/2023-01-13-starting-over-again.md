...
I decided to move my posts over to [Hey World](https://world.hey.com/) that is a free blogging service provided as part the hey.com email that I use.
...
You can check it out [here](https://skaronis.com/).
...
*Originally published on [Substack](https://blog.skaronis.com/p/coming-soon)*